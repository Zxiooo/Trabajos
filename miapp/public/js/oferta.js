document.addEventListener('DOMContentLoaded', function () {
  ...
  // Función para cargar todos los productos en oferta
  function cargarTodosLosProductosEnOferta() {
  ...
  cargarCategorias();
  cargarTodosLosProductosEnOferta();

  // Eventos adicionales
  quitarFiltrosBtn.addEventListener('click', cargarTodosLosProductosEnOferta);
